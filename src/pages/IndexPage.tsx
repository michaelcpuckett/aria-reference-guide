      ...
      <body className="h-full overflow-hidden">
        ...
        <div className="grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)] print:contents max-[720px]:[&:has(#menu-visibility-switch:not(:checked))_#nav]:hidden max-[720px]:[&:has(#menu-visibility-switch:checked)_main]:hidden">
          ...
          <div className="grid min-h-0 min-[721px]:grid-cols-[280px_minmax(0,1fr)]">
            <div
              className="app-nav-panel min-h-0 overflow-y-auto p-4 pl-[calc(1rem+env(safe-area-inset-left))] print:hidden"
              id="nav"
            >
              <Navigation />
            </div>
            <main className="app-main-panel min-h-0 overflow-y-auto p-4 pr-[calc(1rem+env(safe-area-inset-right))] text-lg min-[721px]:min-w-0 min-[721px]:p-12 min-[721px]:pr-[calc(3rem+env(safe-area-inset-right))] print:[&_a]:font-bold print:[&_a]:no-underline print:[&_a]:text-inherit">
              <Overview />
            </main>
          </div>
        </div>
