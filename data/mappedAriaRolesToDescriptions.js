...
exports.mappedAriaRolesToDescriptions = void 0;
exports.mappedAriaRolesToDescriptions = {
    alert: "A type of live region with important and usually time-sensitive information, used to convey messages that may be immediately important to users.",
    alertdialog: "A type of dialog that contains an alert message, used to convey messages to alert the user, which can receive a response from the user.",
    application: "A container with focusable descendants, similar to a composite, but with a non-standard interaction model, switching to passthrough mode so that user events can be processed with JavaScript.",
    article: "A section of a page that forms an independent part of a document, page, or site.",
    ...
    deletion: "Content that is marked as removed or content that is being suggested for removal.",
    ...
    progressbar: "An element that displays the progress status for tasks that take a long time, indicating that the user's request has been received and the application is making progress toward completing the requested action.",
...
//# sourceMappingURL=mappedAriaRolesToDescriptions.js.map